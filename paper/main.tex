...
\title{Automatic transcription for Indian Percussion Instrument}

% a short form should be given in case it is too long for the running head
\titlerunning{Automatic transcription for Indian Percussion Instrument}
...
%
\author{Pranav Sankhe \thanks{Thanks to DAPLAB, IIT Bombay for providing the isolated tabla recordings}}
%
% if the names of the authors are too long for the running head, please use the format: AuthorA et al.
% \authorrunning{Pranav Sankhe}

% the affiliations are given next; don't give your e-mail address
% unless you accept that it will be published
\institute{Indian Institute of Technology, Bombay \and \email{pranavsankhe40@gmail.com}}
